...
/* harmony export (immutable) */ __webpack_exports__["a"] = startEmoji;
...
var cssTextGen = __WEBPACK_IMPORTED_MODULE_0_lodash_fp__["reduce"](function (total, row) {
  return total + (row[0] + ': ' + row[1] + ';');
}, '');

function appendCSS(selector, styles, overlay) {
  var stylestr = cssTextGen(styles);
  var rule = '.' + selector + ' { ' + stylestr + ' }';
  console.log(rule);
